...
//                 for(int k=0;k<p;k++){    //******** */ we can take p and n for the condition******
...
int main() {
    int m;
    cout<<"Enter the number of 1st matrix row : ";
    cin>>m;
    int n;
    cout<<"Enter the number of 1st matrix column : ";
    cin>>n;


    int p;
    cout<<"Enter the number of the 2nd matrix row : ";
    cin>>p;
    int q;
    cout<< "Enter the number of the 2nd matrix column : ";
    cin>>q;

    //CONDITION OF THE MULTIPLICATION 
    if(n == p){
        vector<vector<int>>a(m,vector<int>(n));
